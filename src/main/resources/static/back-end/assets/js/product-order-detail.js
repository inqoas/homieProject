...
//                         var sec2 = $('#ajax2');
//                         console.log(orderProductDetailData);
//                         sec2.empty();
...
//                         $.ajax({
//                             url: `${getUserAddressAPI}?user_id=${orderProductData.user_id}`,
//                             type: 'GET',
//                             dataType: "json",
...
//                                         <li>訂單編號: ${orderProductData.order_product_id}</li>
//                                         <li>下單日期: ${orderProductData.product_placement_time}</li>
//                                         <li>訂單金額: $${totalAmount}</li>
//                                     </ul>
